...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>ST. PETER HOMES,</p>
				<p>National Highway<br>Brgy. Surok,<br>Guiuan Eastren Samar.</p>
				<p>(+63) 926 222 44 55</p>
			</address>
			<span><img alt="" src="assets/img/logo 2.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@stpeterg.com || Web :- www.stpeter.com || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
